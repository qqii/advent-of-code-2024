...
{
  try {
    CLI::App app{ fmt::format("{} version {}", advent_of_code_2024::cmake::project_name, advent_of_code_2024::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", advent_of_code_2024::cmake::project_version);
      return EXIT_SUCCESS;
    }
